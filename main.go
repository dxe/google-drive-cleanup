...
func init() {
	...
	rootCmd.AddCommand(initCmd, crawlCmd, ownersCmd, pathCmd, checkEditAccessCmd, exploreCmd, packCmd, unpackCmd, reviewCmd, exportReviewCmd, keepRecentCmd, archiveCmd, deleteCmd, restoreCmd, backupCmd)
}
